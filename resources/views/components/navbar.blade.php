...
<nav id="navbar"
    ...
    <div class="flex flex-wrap items-center justify-between py-6">
        <div class="group flex w-1/2 items-center space-x-3 md:w-auto">
            ...
            <a href="index.html" class="text-2xl font-bold text-white hover:text-lime-400" onmouseover="changeImage(true)"
        ...
        <div class="hidden w-full md:block md:w-auto" id="menu">
            <nav class="bg-gree-900 mt-4 w-full rounded px-6 py-4 text-center shadow-lg md:mt-0 md:bg-transparent md:p-0 md:shadow-none">
                <ul class="items-center md:flex">
                    <li class="md:ml-4"><a
                            class="inline-block py-2 font-semibold hover:text-lime-400 md:px-2 md:text-white"
                    ...
                    <li class="mt-3 md:ml-6 md:mt-0">
                        <a class="inline-block rounded border border-white bg-blue-600 px-4 py-2 font-semibold text-white hover:text-lime-400 md:bg-transparent md:text-white"
